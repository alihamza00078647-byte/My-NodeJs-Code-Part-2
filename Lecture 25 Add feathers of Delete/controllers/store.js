...
exports.removefavouriteList = (req, res, next) => {
    const favouriteId = req.params.favouriteId;
    favourite.removefavouriteById(favouriteId, favouriteList => {
        console.log("Favourite Delete Error: ", favouriteList);
    });
    res.redirect('/favourite');
}